...
public class LandscapeViewImp extends BaseViewImp implements ItemCallback, ElementCallback, LandscapeView {
    ...
    public LandscapeViewImp(final LayoutInflater inflater, final ViewGroup parent, final ActivityCallback activityCallback) {
